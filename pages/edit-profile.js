  ...
  handleSubmit = (event) => {
    ...
    updateUser(this.state._id, this.userData)
      .then((updatedUser) => {
        ...
        setTime(() => Router.push(`/profile/${this.state._id}`), 6000);
      })
    ...
    return (
      <div className={classes.root}>
        <Paper className={classes.paper}>
          ...
          <form onSubmit={this.hadleSubmit} className={classes.form}>
            {isLoading ? (
        ...
        <Dialog open={openSuccess} disableBackdropClick={true}>
          ...
          <DialogContent>
            <DialogContentText>
              User {updatedUser && updatedUser.name} was successfuly updated !
            </DialogContentText>
          </DialogContent>
        </Dialog>
      </div>
